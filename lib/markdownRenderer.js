...
export class MarkdownRenderer {
    ...
    render(text) {
        ...
        // Preserve newlines by converting them to HTML line breaks first
        ...
        // Create label with proper text wrapping settings
        const label = new St.Label({
            x_expand: true,
        });
        
        // Enable line wrapping BEFORE setting text
        ...
        if (processedText.includes('<') && processedText.includes('>')) {
            ...
            // Set plain text for non-markup content
            label.set_text(processedText);
        }
